...
#ifndef ROSBAG2_TRANSPORT__MOCK_SEQUENTIAL_REINDEXER_HPP_
#define ROSBAG2_TRANSPORT__MOCK_SEQUENTIAL_REINDEXER_HPP_
...
class MockSequentialReindexer : public rosbag2_cpp::reindexer_interfaces::BaseReindexerInterface
{
public:
  void open(
...
#endif  // ROSBAG2_TRANSPORT__MOCK_SEQUENTIAL_REINDEXER_HPP_
