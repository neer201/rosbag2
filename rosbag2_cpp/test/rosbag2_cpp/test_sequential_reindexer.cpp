...
class SequentialReindexerTest : public Test
{
public:
  SequentialReindexerTest()
...
TEST_F(SequentialReindexerTest, read_next_uses_converters_to_convert_serialization_format) {
...
TEST_F(SequentialReindexerTest, open_throws_error_if_converter_plugin_does_not_exist) {
  std::string output_format = "rmw2_format";
...
TEST_F(SequentialReindexerTest, set_filter_calls_storage) {
